...
public class Post_TC_2 {
	public static void execute() throws IOException {
		...
		String requestBody=Post_Req_Repository1.post_req_tc2();
		...
		Utility_CommonFunction.EvidenceFileCreator("Post_TC_2", requestBody, responseBody);
		break;
		}
		else
		{
		...
		JsonPath jspreq=new JsonPath( Post_Req_Repository1.post_req_tc2());
